...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    //On peut faire l'injection des dependances via le constructeur ou via @Autowired
    ...
    */
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        */
        ...
        User user = new User(appUser.getUsername(),appUser.getPassword(),authorities1); //la classe User implemente UserDetailsService
        return user;
    }
}
